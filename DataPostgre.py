    ...
    def create_profile(self, telegram_id, telegram_username, name, description, city, photo, sex, age):
        with self.connection:
            return self.cursor.execute(
                "INSERT INTO profile_list (telegram_id, telegram_username, name, description, city, photo, sex, age) VALUES(%s, %s, %s, %s, %s, %s, %s, %s)",
                (telegram_id, telegram_username, name, description, city, photo, sex, age))
